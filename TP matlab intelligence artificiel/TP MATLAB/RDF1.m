...
[alphabet,targets] = prpronum; %PRPROB Character recognition problem definition
[R,Q] = size(alphabet);
[S2,Q] = size(targets);
...
i=2;
%le nombre 18
noisy1 = P(:,i);%+randn(35,1) * 0.2;
noisy8 = P(:,9);%+randn(35,1) * 0.2;
figure,subplot(1,2,1),plotchar(noisy1),subplot(1,2,2),plotchar(noisy8);
A2 = sim(net,noisy1);
A2 = compet(A2);
